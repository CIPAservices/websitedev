...
export default function CustomCarousel() {
  return (
    <div className="relative w-full max-w-full h-97 overflow-hidden bg-[url('/images/mapyellow.png')] bg-cover bg-no-repeat bg-top animate-bgMove">
      <div className="absolute inset-0 bg-blue-500/15"></div>

      <div className="absolute w-full h-full transition-opacity duration-700">
        <div className="flex flex-col absolute inset-0 items-center justify-center text-center z-10">
          <div className="bg-black backdrop-blur-2xl rounded-2xl opacity-80 sm:p-5">
          <h1 className="text-4xl font-bold md:text-6xl px-4 py-2 text-white">
            Empowering Communities
          </h1>
          </div>
          <div className="bg-black my-2 rounded-2xl opacity-80  sm:p-5">
