  ...
  return (
    <section className="flex flex-col items-center justify-center px-4 pt-5">
      ...
      <Card className="w-full max-w-3xl border-2 rounded-lg p-8">
        ...
        &quot;To empower immigrant professionals by providing personalized coaching,
          ...
          — whether academic, technical, vocational, creative, entrepreneurial, or licensed — to achieve career alignment, social integration, and long-term success in Canada.&quot;
        </blockquote>
      </Card>
    </section>
  );
